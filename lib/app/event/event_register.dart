...
class EventRegisterPage extends StatefulWidget {
  ...
  EventRegisterPage({super.key, required this.event});

  @override
  State<EventRegisterPage> createState() => _EventDetailPageState();
}

class _EventDetailPageState extends State<EventRegisterPage> {
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                ...
                                overflow:
                                    TextOverflow
                                        .ellipsis, // In case of long titles
                              ),
                            ),
                            Row(
                              children: [
